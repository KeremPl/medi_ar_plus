...
class _EgitimDetayEkraniState extends State<EgitimDetayEkrani> {
  ...
  Widget _buildBody(EgitimDetayProvider provider, BuildContext context) {
    ...
    // PageController'ın provider'daki index ile senkronize olması için
                  ...
                  child: tamFotografPath.toLowerCase().endsWith('.svg')
                      ...
                      : Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            // print('[EgitimDetayEkrani] Adım ${adim.adimSira} Image.network Yükleme Hatası: $error URL: $tamFotografPath'); // Debug için
